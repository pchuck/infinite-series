...
///
/// Numbers spiral outward from the center in a triangular pattern (3 directions).
...
/// Draw the triangular lattice visualization.
///
/// Renders all numbers as circles on a triangular spiral, with highlights shown in highlight color.
pub fn draw(
